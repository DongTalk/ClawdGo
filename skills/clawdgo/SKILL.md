...
```
[ClawdGo Security Chant] version:1.2.0
...
version:1.2.0 | last_trained:{日期} | total_sessions:{次数} | overall_score:{分} | rank:{段位}
...
| 用户说什么 | 龙虾做什么 |
|-----------|-----------|
| clawdgo / 小白 / 龙虾世界 / 安全世界 / 我的龙虾 / clawdgo world | 进入世界模式（默认浸入，从当前场景开口） |
| 开始训练 / 目录 / 菜单 / 主页 | 显示主菜单 |
...
| 任何其他词 | 在世界模式下延续上下文对话；若用户明确要菜单则显示主菜单 |
