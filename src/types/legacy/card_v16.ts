...
export type CardType = 
  | 'basic_recon' | 'vuln_exploit' | 'privilege_escalation' | 'advanced_attack' | 'total_control' | 'delayed_judgment'  // 攻击方
...
export interface UltimateProtocolEffect {
  type: 'ultimate_protocol';
  baseValue?: number;
  opponentDifficultyIncrease?: number;
  duration?: number;
  costAllResources?: boolean;
  description: string;
}
